...
// Construir el cuerpo del email con estilos
$message = '<html><body style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">';
...
$message .= '<div style="background: linear-gradient(135deg, #c5b993 0%, #a89367 100%); color: white; padding: 30px; text-align: center; border-radius: 8px; margin-bottom: 30px;">';
$message .= '<h1 style="margin: 0; font-size: 28px; font-weight: bold;">Nueva Solicitud de Contacto</h1>';
$message .= '</div>';

$message .= '<div style="color: #757F95; font-size: 14px; margin-bottom: 20px; line-height: 1.6;">';
...
$message .= '<p style="margin: 0; color: #757F95;">'.$subject.'</p>';
$message .= '</div>';
...
$message .= '<div style="color: #757F95; font-size: 12px; border-top: 1px solid #e0e0e0; padding-top: 20px; margin-top: 20px; line-height: 1.6;">';
$message .= '<p>Responde directamente a '.$email.' para contactar con el solicitante.</p>';
$message .= '</div>';
